...
OUTPUT_DIR=./results_yotam/cube4pose1_biquadratic+handles
...
FLAT_INTERSECTION_ARGS="--energy biquadratic+handles --handles 5 --fancy-init "${OUTPUT_DIR}"/local_subspace_recover.txt"
