...
OUTPUT_DIR=./results_yotam/cube4pose1_default
...
FLAT_INTERSECTION_ARGS="--energy biquadratic --handles 5 --fancy-init "${OUTPUT_DIR}"/local_subspace_recover.txt"
# SIMPLEX_HULL_ARGS="-R 0.01"
SIMPLEX_HULL_ARGS="--dimension 3"
