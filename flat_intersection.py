...
def optimize_nullspace_pymanopt(P, H, row_mats, deformed_vs, x0, strategy = None, max_iter = None, nullspace = None):
	...
	if(subset>0):
		...
		if output_folder is not None:
			...
			for i in range(H):
				...
				output_path = os.path.join( output_folder, name + ".DMAT" )
