...
SSD_RESULT_UNCONSTRAINED="${ROOT_DIR}"/SSD_unconstrained/lion-poses-40-unconstrained.txt

INITIAL_GUESS_ARGS="--svd_threshold 1e-15 --transformation_threshold 1e-4 --version 0"
FLAT_INTERSECTION_ARGS="--strategy ssv:weighted --energy biquadratic --W-projection normalize --x-eps 0.1 --handles 40 --fancy-init ${OUTPUT_DIR}/local_subspace_recover.txt"
