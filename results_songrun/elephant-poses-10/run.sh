...
REST_POSE="${ROOT_DIR}"/models/elephant-poses.obj
OTHER_POSE_DIR="${ROOT_DIR}"/models/elephant-poses
# SSD_RESULT="${ROOT_DIR}"/SSD_res/elephant-poses-10-output.txt
SSD_RESULT="${ROOT_DIR}"/SSD_res/elephant-poses-10-unconstrained.txt
