...
REST_POSE="${ROOT_DIR}"/models/camel-collapse.obj
OTHER_POSE_DIR="${ROOT_DIR}"/models/camel-collapse
# SSD_RESULT="${ROOT_DIR}"/SSD_res/camel-collapse-output.txt
