...
OTHER_POSE_DIR="${ROOT_DIR}"/models/cheburashka/poses-1


INITIAL_GUESS_ARGS="--svd_threshold 1e-15 --transformation_threshold 1e-4 --version 0"
FLAT_INTERSECTION_ARGS="--energy biquadratic --W-projection normalize --max-iter 2 --handles 11 --fancy-init "${OUTPUT_DIR}"/local_subspace_recover.txt"
