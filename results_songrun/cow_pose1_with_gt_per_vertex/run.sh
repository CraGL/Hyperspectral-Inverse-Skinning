...
SIMPLEX_HULL_ARGS="-D 14 --method lp --output ./result.txt"
...
python3 -u "${ROOT_DIR}"/simplex_hull.py "${OTHER_POSE_DIR}" ${SIMPLEX_HULL_ARGS} 2>&1 | tee "${OUTPUT_DIR}"/simplex_hull.out
