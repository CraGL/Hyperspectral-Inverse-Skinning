...
REST_POSE="${ROOT_DIR}"/models/horse-poses.obj
OTHER_POSE_DIR="${ROOT_DIR}"/models/horse-poses
# SSD_RESULT="${ROOT_DIR}"/SSD_res/horse-poses-10-output.txt
SSD_RESULT="${ROOT_DIR}"/SSD_res/horse-poses-10-unconstrained.txt
