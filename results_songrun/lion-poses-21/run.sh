...
FLAT_INTERSECTION_ARGS="--strategy ssv:weighted --energy biquadratic --W-projection normalize --x-eps 0.1 --handles 21 --fancy-init ${OUTPUT_DIR}/local_subspace_recover.txt"
