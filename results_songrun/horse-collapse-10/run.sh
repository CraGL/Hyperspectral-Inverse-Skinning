...
REST_POSE="${ROOT_DIR}"/models/horse-collapse.obj
OTHER_POSE_DIR="${ROOT_DIR}"/models/horse-collapse
# SSD_RESULT="${ROOT_DIR}"/SSD_res/horse-collapse-10-output.txt
SSD_RESULT="${ROOT_DIR}"/SSD_res/horse-collapse-10-unconstrained.txt
