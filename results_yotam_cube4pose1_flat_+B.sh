...
OUTPUT_DIR=./results_yotam/cube4pose1_flat_+B
...
FLAT_INTERSECTION_ARGS="--energy biquadratic+B -GT "${OTHER_POSE_DIR}" --error True --handles 4 --fancy-init "${OUTPUT_DIR}"/local_subspace_recover.txt"
