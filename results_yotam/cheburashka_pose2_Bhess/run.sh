...
FLAT_INTERSECTION_ARGS="--energy B --strategy hessian --max-iter 100 -GT ${OTHER_POSE_DIR} --error True --handles 11 --fancy-init ${OUTPUT_DIR}/local_subspace_recover.txt"
