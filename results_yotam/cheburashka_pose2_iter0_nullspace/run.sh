...
INITIAL_GUESS_ARGS="--svd_threshold 1e-15 --transformation_threshold 1e-4 --version 0 --method nullspace"
...
FLAT_INTERSECTION_ARGS="--energy biquadratic --W-projection normalize --max-iter 0 --f-eps 0 -GT ${OTHER_POSE_DIR} --error True --handles 11 --fancy-init ${OUTPUT_DIR}/local_subspace_recover.txt"
