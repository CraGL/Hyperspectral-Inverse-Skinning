...
FLAT_INTERSECTION_ARGS="--energy biquadratic --W-projection normalize --max-iter 1 --f-eps 0 -GT ${OTHER_POSE_DIR} --error True --handles 11 --fancy-init ${OUTPUT_DIR}/local_subspace_recover.txt"
