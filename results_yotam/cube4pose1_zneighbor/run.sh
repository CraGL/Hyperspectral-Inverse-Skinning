...
FLAT_INTERSECTION_ARGS="--energy biquadratic --z-strategy neighbors --max-iter 61 -GT "${OTHER_POSE_DIR}" --error True --handles 4 --fancy-init "${OUTPUT_DIR}"/local_subspace_recover.txt"
