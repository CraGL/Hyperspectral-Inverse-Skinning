...
FLAT_INTERSECTION_ARGS="--energy biquadratic --W-projection first --x-eps 0.01 --f-eps 0 -GT ${OTHER_POSE_DIR} --error True --handles 11 --fancy-init ${OUTPUT_DIR}/local_subspace_recover.txt --fancy-init-errors ${OUTPUT_DIR}/local_subspace_recover_errors.txt --fancy-init-ssv ${OUTPUT_DIR}/local_subspace_recover_ssv.txt"
