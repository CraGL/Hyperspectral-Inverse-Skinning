...
INITIAL_GUESS_ARGS="--svd_threshold -1.0 --transformation_threshold 1e20 --version 0 --pinv True"
FLAT_INTERSECTION_ARGS="--energy laplacian -GT "${OTHER_POSE_DIR}" --error True --handles 4 --fancy-init "${OUTPUT_DIR}"/local_subspace_recover.txt"
