...
SIMPLEX_HULL_ARGS="-D 10 --method scipy --WPCA True --transformation-errors ${OUTPUT_DIR}/local_subspace_recover_errors.txt --transformation-ssv ${OUTPUT_DIR}/local_subspace_recover_ssv.txt"
