...
FLAT_INTERSECTION_ARGS="--energy B --strategy gradient --nullspace True --max-iter 10000 -GT ${OTHER_POSE_DIR} --error True --handles 11 --fancy-init ${OUTPUT_DIR}/local_subspace_recover.txt"
