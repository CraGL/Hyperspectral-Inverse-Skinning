...
FLAT_INTERSECTION_ARGS="--energy biquadratic --strategy pinv+ssv:weighted -GT "${OTHER_POSE_DIR}" --error True --handles 11 --fancy-init "${OUTPUT_DIR}"/local_subspace_recover.txt"
