...
FLAT_INTERSECTION_ARGS="--energy biquadratic --W-projection normalize --f-eps 1e-12 -GT ${OTHER_POSE_DIR} --error True --handles 11 --fancy-init ${OUTPUT_DIR}/local_subspace_recover.txt"
